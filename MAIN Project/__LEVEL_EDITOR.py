...
def main_scene():
	...
	Entity(model=obf+'e_room/e_room.ply',texture=obf+'e_room/e_room.tga',scale=.025,rotation=(-90,90,0),position=(0+st.m_size[0]/2,2,st.m_size[1]+4),unlit=False,alpha=st.object_alpha)
	LE.SpawnMenu()
	LE.MapInfo()
