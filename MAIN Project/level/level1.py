...
def load_object():
	...
	o.gr_block(p=(0,dy,dz+14),vx=[1,5])
	o.gr_block(p=(0,dy,dz+26),vx=[1,5])
	...
	o.gr_block(p=(-2,dy,dz+60),vx=[5,1])
	o.gr_block(p=(-2,dy,dz+61),vx=[1,5])
	o.gr_block(p=(-2,dy,dz+68),vx=[1,4])
	o.gr_block(p=(+2,dy,dz+61),vx=[1,4])
	o.gr_block(p=(+2,dy,dz+68+.32),vx=[1,2])
	o.gr_block(p=(+2,dy,dz+72),vx=[1,1])
	o.gr_block(p=(-2,dy,dz+73),vx=[5,1])
	o.gr_block(p=(0,dy,dz+74),vx=[1,2])
	o.gr_block(p=(0,dy,dz+81),vx=[1,2])
	o.gr_block(p=(0,dy,dz+83),vx=[1,3])
...
def bonus_zone():
	...
	o.gr_block(p=(3,-37.65,U),vx=[2,1],sca=(.5,.75,.3))
	o.gr_block(p=(6,-37.65,U),vx=[2,1],sca=(.5,.75,.3))
	o.gr_block(p=(9,-37.65,U),vx=[3,1],sca=(.5,.75,.3))
...
def gem_zone():
	...
	o.gr_block(p=(199.5,0,-3),vx=[2,2],sca=(.5,.5,.3))
	o.gr_block(p=(202,.5,-2),vx=[1,1],sca=(.5,.5,.3))
	o.gr_block(p=(204,.5,-2),vx=[3,1],sca=(.5,.5,.3))
	o.gr_block(p=(208,1,-2),vx=[1,1],sca=(.5,.5,.3))
	o.gr_block(p=(210,2.2,-2),vx=[3,1],sca=(.5,.5,.3))
	o.gr_block(p=(214,1.7,-2),vx=[1,1],sca=(.5,.5,.3))
	o.gr_block(p=(218,1.75,-2),vx=[4,1],sca=(.5,.5,.3))
	o.gr_block(p=(231,2,-2),vx=[1,1],sca=(.5,.5,.3))
	o.gr_block(p=(233,2.5,-2),vx=[1,1],sca=(.5,.5,.3))
	o.gr_block(p=(234,3,-2),vx=[4,1],sca=(.5,.5,.3))
	#npc
