...
def bonus_zone():
	...
	del w
	bnh=-37
	o.spw_block(p=(.35,bnh,U),vx=[2,1],sca=(.5,.75,.1),ID=0)
	o.spw_block(p=(3,bnh,U),vx=[2,1],sca=(.5,.75,.1),ID=0)
	o.spw_block(p=(6,bnh,U),vx=[2,1],sca=(.5,.75,.1),ID=0)
	o.spw_block(p=(9,bnh,U),vx=[3,1],sca=(.5,.75,.1),ID=0)
...
def gem_zone():
	...
	del w
	o.spw_block(ID=0,p=(199.5,0,-3),vx=[2,2],sca=(.5,.5,.3))
	o.spw_block(ID=0,p=(202,.5,-2),vx=[1,1],sca=(.5,.5,.3))
	o.spw_block(ID=0,p=(204,.5,-2),vx=[3,1],sca=(.5,.5,.3))
	o.spw_block(ID=0,p=(208,1,-2),vx=[1,1],sca=(.5,.5,.3))
	o.spw_block(ID=0,p=(210,2.2,-2),vx=[3,1],sca=(.5,.5,.3))
	o.spw_block(ID=0,p=(214,1.7,-2),vx=[1,1],sca=(.5,.5,.3))
	o.spw_block(ID=0,p=(218,1.75,-2),vx=[4,1],sca=(.5,.5,.3))
	o.spw_block(ID=0,p=(231,2,-2),vx=[1,1],sca=(.5,.5,.3))
	o.spw_block(ID=0,p=(233,2.5,-2),vx=[1,1],sca=(.5,.5,.3))
	o.spw_block(ID=0,p=(234,3,-2),vx=[4,1],sca=(.5,.5,.3))
	#npc
