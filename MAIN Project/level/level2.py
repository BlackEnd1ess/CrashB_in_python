...
def load_object():
	...
	#first pass
	phg=-.065
	o.spw_block(sca=.5,ro_y=180,p=(0,phg,-60.5),vx=[1,2],ID=1)
	o.spw_block(sca=.5,ro_y=180,p=(-1,phg,-57.5),vx=[3,2],ID=1)
	o.spw_block(sca=.5,ro_y=180,p=(-1,phg,-43),vx=[3,1],ID=1)
	o.spw_block(sca=.5,ro_y=180,p=(0,phg,-42),vx=[1,3],ID=1)
	o.spw_block(sca=.5,ro_y=180,p=(-1,phg,-22),vx=[3,1],ID=1)
	o.spw_block(sca=.5,ro_y=180,p=(0,phg,-21),vx=[1,2],ID=1)
	o.spw_block(sca=.5,ro_y=180,p=(0,phg,-19),vx=[2,1],ID=1)
	o.spw_block(sca=.5,ro_y=180,p=(-1,phg,-1),vx=[3,1],ID=1)
	o.spw_block(sca=.5,ro_y=180,p=(0,phg,0),vx=[1,3],ID=1)
	#2d area
	bz=2.7
	nh=.25
	nv=1.2
	nf=5
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(-1,nh,bz),vx=[3,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(3,nh,bz),vx=[1,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(4,.75,bz),vx=[1,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(5,nv,bz),vx=[2,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(8,nv,bz),vx=[1,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(10,nv,bz),vx=[2,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(12,nv+.4,bz),vx=[2,1])
	
	o.ObjType_Floor(ID=0,pos=(16.4,2.05,bz+.1),sca=(6,1))
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(19.8,nv+.4,bz),vx=[2,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(21.8,nv+1,bz),vx=[1,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(22.8,nv+2,bz),vx=[1,1])
	# final area
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(23,nv+3.2,3.3),vx=[1,2])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(22,nv+3.2,5.3),vx=[3,3])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(22,nv+3.2,20),vx=[3,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(23,nv+3.2,21),vx=[1,2])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(23,nv+3.2,24),vx=[1,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(23,nv+3.2,26),vx=[2,2])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(30.1,nv+3.2,26.7),vx=[2,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(32.1,nv+3.8,26.7),vx=[1,1])
	# room area
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(40,nf,30),vx=[4,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(41.5,nf,31),vx=[1,2])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(40.5,nf,33),vx=[3,1])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(41.5,nf,34),vx=[1,3])
	o.spw_block(ID=1,sca=.5,ro_y=180,p=(40.5,nf+.4,37),vx=[4,3])
	#pillar
	phe=1.1
...
def bonus_zone():
	...
	o.spw_block(p=(0,-38.5,U),sca=.5,ro_y=180,vx=[1,1],ID=1)
	o.spw_block(p=(2,-38.2,U),sca=.5,ro_y=180,vx=[4,1],ID=1)
	o.spw_block(p=(7,-38.2,U),sca=.5,ro_y=180,vx=[3,1],ID=1)
	o.spw_block(p=(12.8,-38.2,U),sca=.5,ro_y=180,vx=[3,1],ID=1)
	for sw in range(5):
