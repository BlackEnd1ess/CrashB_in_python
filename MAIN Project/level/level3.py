...
def load_object():
	...
	#e1
	nh=1.09
	o.spw_block(ID=3,p=(.85,tH+nh,0),vx=[1,6])
	o.spw_block(ID=3,p=(-.85,tH+nh,2),vx=[1,1])
	o.spw_block(ID=3,p=(-.85,tH+nh,.85*5),vx=[2,1])
	...
	#e3
	lb=1.79
	o.spw_block(ID=3,p=(0,1.72,57.4),vx=[1,1])
	o.spw_block(ID=3,p=(0,lb,66.5),vx=[1,3])
	o.spw_block(ID=3,p=(0,lb,66.5+.85*7),vx=[1,4])
