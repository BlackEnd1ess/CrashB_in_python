...
def load_crate():
	...
	mt.crate_plane(ID=1,POS=(4.9,1.9,42.9),CNT=[2,2])
...
def load_wumpa():
	mt.wumpa_row(POS=(0,.56+.2,-58.7),CNT=3,WAY=1)
	mt.wumpa_row(POS=(-.5,.16+.2,-51.8),CNT=5,WAY=1)
	mt.wumpa_row(POS=(.8,.56+.2,-50),CNT=3,WAY=1)
	mt.wumpa_row(POS=(.6,.16+.2,-41.9),CNT=3,WAY=1)
	mt.wumpa_row(POS=(.5,.16+.2,-26.6),CNT=3,WAY=1)
	mt.wumpa_row(POS=(-1.0,.56+.2,-13.1),CNT=3,WAY=1)
	mt.wumpa_row(POS=(0,.91+.2,4.4),CNT=3,WAY=1)
	mt.wumpa_row(POS=(5.2,1.91+.2,8.3),CNT=3,WAY=1)
	mt.wumpa_row(POS=(5.5,1.91+.2,18.9),CNT=3,WAY=1)
	mt.wumpa_row(POS=(4.5,1.91+.2,22),CNT=4,WAY=1)
	mt.wumpa_row(POS=(5,1.91+.2,25.4),CNT=3,WAY=1)
	mt.wumpa_row(POS=(5,1.91+.2,33.1),CNT=3,WAY=1)
	mt.wumpa_row(POS=(5,1.91+.2,44.5),CNT=3,WAY=1)
	mt.wumpa_row(POS=(14.5,3.91+.2,50.6),CNT=3,WAY=1)
	mt.wumpa_row(POS=(14.6,3.56+.2,62.7),CNT=3,WAY=1)
	...
	mt.wumpa_row(POS=(4,1.95,36),CNT=4,WAY=0)
	mt.wumpa_row(POS=(5.4,1.95,48.5),CNT=4,WAY=0)
