...
def load_object():
	...
	o.spw_block(ID=4,p=(4.5,pg+1,(.5*44)),vx=[2,1])
	...
	o.spw_block(ID=4,p=(12.5,pg+2,(.5*97)),vx=[1,1])
	o.spw_block(ID=4,p=(13.5,pg+2.5,(.5*97)),vx=[1,1])
	o.spw_block(ID=4,p=(14.5,pg+3,(.5*97)),vx=[1,3])
	#e2
	o.spw_block(ID=4,p=(14.5,pg+3,58),vx=[2,2])
...
def bonus_zone():
	...
	o.spw_block(ID=4,p=(3,-35.5,U),vx=[4,1])
	o.spw_block(ID=4,p=(5,-34,U),vx=[7,1])
	o.spw_block(ID=4,p=(9,-34,U),vx=[3,1])
	o.spw_block(ID=4,p=(8.5,-36,U),vx=[5,1])
	o.spw_block(ID=4,p=(12,-36,U),vx=[3,1])
	o.spw_block(ID=4,p=(14,-35.5,U),vx=[1,1])
	o.spw_block(ID=4,p=(15,-35,U),vx=[1,1])
	o.spw_block(ID=4,p=(16,-34.5,U),vx=[1,1])
	o.spw_block(ID=4,p=(17,-34.5,U),vx=[4,1])
	o.spw_block(ID=4,p=(20,-34.5,U),vx=[4,1])
	#crate
