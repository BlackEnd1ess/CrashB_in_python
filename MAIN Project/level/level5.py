import settings,objects,map_tools,crate,npc,status,item,random,_loc,sys,os
...
def map_setting():
	...
	scene.fog_density=(8,15)
	scene.fog_color=color.black
	LC.AMBIENT_LIGHT.color=color.rgb32(140,140,160)
...
def load_object():
	...
	o.spw_block(ID=5,p=(0,blh,-61),vx=[1,3])
	o.spw_block(ID=5,p=(0,blh,-61+.75*5),vx=[1,1])
	o.spw_block(ID=5,p=(1.2,blh,-56),vx=[1,1])
	o.spw_block(ID=5,p=(1.2+.75*2,blh,-56),vx=[1,1])
	o.spw_block(ID=5,p=(1.2+.75*4,blh,-56),vx=[1,1])
	o.spw_block(ID=5,p=(1.2+.75*2,blh,-55.25),vx=[1,2])
	o.spw_block(ID=5,p=(1.2+.75*2,blh,-55.25+.75*4),vx=[1,1])
	o.spw_block(ID=5,p=(1.2+.75*2,blh,-50.5),vx=[1,1])
	o.RuinsCorridor(pos=(2.7,blh-.5,-47))
	
	o.spw_block(ID=5,p=(1.2+.75*2,blh,-44),vx=[1,1])
	o.spw_block(ID=5,p=(1.2+.75*2,blh,-44+.75*2),vx=[1,1])
	o.spw_block(ID=5,p=(1.2+.75*2,blh,-44+.75*4),vx=[1,1])
	o.spw_block(ID=5,p=(1.2+.75*2,blh,-44+.75*6),vx=[1,1])
	o.spw_block(ID=5,p=(1.2+.75*1,blh,-44+.75*7),vx=[3,1])
	o.spw_block(ID=5,p=(1.2+.75*2,blh,-44+.75*9),vx=[1,1])
	o.spw_block(ID=5,p=(1.2+.75*2,blh,-44+.75*11),vx=[1,1])
	...
	o.spw_block(ID=5,p=(9,blh,-33),vx=[2,1])
	o.spw_block(ID=5,p=(9+.75*4,blh,-33),vx=[1,3])
	o.RuinsCorridor(pos=(12,blh-.5,-28.5))
	o.spw_block(ID=5,p=(9+.75*4,blh,-25),vx=[1,1])
	o.spw_block(ID=5,p=(9+.75*4,blh,-23.5),vx=[1,1])
	o.spw_block(ID=5,p=(9+.75*4,blh,-22),vx=[3,1])
	o.spw_block(ID=5,p=(9+.75*4,blh,-20.5),vx=[1,1])
	...
	o.spw_block(ID=5,p=(9+.75*4,blh,-8.1),vx=[1,1])
	o.RuinsPlatform(pos=(12,blh,-6.9),m=False)
	o.spw_block(ID=5,p=(13.2,blh,-7),vx=[1,4])
	o.spw_block(ID=5,p=(13.2,blh,-7+.75*5.5),vx=[1,1])
	o.spw_block(ID=5,p=(13.2,blh,-7+.75*8),vx=[1,1])
	o.spw_block(ID=5,p=(14.7,blh,-7+.75*8),vx=[2,1])
	o.spw_block(ID=5,p=(14.7+.75*3,blh,-7+.75*8),vx=[2,1])
	o.LoosePlatform(pos=(19,.2,-1),t=0)
	o.LoosePlatform(pos=(20.5,.2,-1),t=0)
	o.spw_block(ID=5,p=(22,blh,-7+.75*8),vx=[4,1])
	o.spw_block(ID=5,p=(22+.75*4,blh,-7+.75*8),vx=[1,2])
	o.spw_block(ID=5,p=(22+.75*4,blh,-7+.75*11),vx=[1,1])
	o.spw_block(ID=5,p=(22+.75*4,blh,-7+.75*13),vx=[1,1])
	o.spw_block(ID=5,p=(22+.75*6,blh,-7+.75*8),vx=[1,1])
	o.spw_block(ID=5,p=(22+.75*8,blh,-7+.75*8),vx=[1,1])
	...
	blk=1.1
	o.spw_block(ID=5,p=(30,blk,4.7),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*2,blk,4.7),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*4,blk,4.7),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*6,blk,4.7),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*6,blk,4.7+.75*2),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*6,blk,4.7+.75*4),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*6,blk,4.7+.75*5),vx=[2,1])
	o.spw_block(ID=5,p=(30+.75*10,blk,4.7+.75*5),vx=[3,1])
	o.spw_block(ID=5,p=(30+.75*12,blk,4.7),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*12,blk,4.7+.75*2),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*12,blk,4.7+.75*4),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*14,-.2+.5,4.7),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*16,-1+.5,4.7),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*18,-1+.5,4.7),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*20,-1+.5,4.7),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*22,-1+.5,4.7),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*24,-.6+.5,4.7),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*25,-.2+.5,4.7),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*25,.2+.5,4.7+.75),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*26,blk,4.7+.75),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*28,blk,4.7+.75),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*30,blk,4.7+.75),vx=[1,1])
	o.RuinsPlatform(pos=(35.5,blk,9.6),m=False)
	o.RuinsPlatform(pos=(37.175,blk-.001,9.6),m=True)
	o.spw_block(ID=5,p=(30+.75*31,blk,4.7+.75),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*31,blk,4.7+.75*3),vx=[1,1])
	o.spw_block(ID=5,p=(30+.75*31,blk,4.7+.75*5),vx=[1,1])
	...
	o.spw_block(ID=5,p=(52.45,blk,15.75),vx=[3,2])
	o.spw_block(ID=5,p=(53.2-.75,blk,15+.75*3),vx=[1,1])
	o.spw_block(ID=5,p=(53.2-.75,blk,15+.75*5),vx=[1,1])
	o.spw_block(ID=5,p=(53.2-.75,blk,15+.75*7),vx=[1,1])
	o.spw_block(ID=5,p=(53.2-.75,blk,15+.75*8),vx=[1,1])
	o.spw_block(ID=5,p=(53.2-.75+.75*2,blk,15+.75*8),vx=[1,1])
	o.spw_block(ID=5,p=(53.2-.75+.75*4,blk,15+.75*8),vx=[1,1])
	o.spw_block(ID=5,p=(53.2+.75*3,blk,15+.75*8),vx=[1,1])
	o.spw_block(ID=5,p=(53.2+.75*3,blk,15+.75*10),vx=[1,1])
	o.spw_block(ID=5,p=(53.2+.75*3,blk,15+.75*12),vx=[1,4])
	o.spw_block(ID=5,p=(53.2+.75*4,blk,15+.75*13),vx=[1,1])
	#red gem path
	o.spw_block(ID=5,p=(42.75,-.5,-1.4),vx=[3,3])
	#all gem path
	o.spw_block(ID=5,p=(59.5,blk,15.75),vx=[3,2])
	#sculpts
...
def bonus_zone():
	...
	o.spw_block(ID=5,p=(-1,-36.5,U),vx=[4,1])
	o.spw_block(ID=5,p=(2,-36,U),vx=[2,1])
	o.spw_block(ID=5,p=(4.5,-36,U),vx=[3,1])
	o.spw_block(ID=5,p=(6.75,-35.5,U),vx=[4,1])
	o.LoosePlatform(pos=(10,-35.5,U),t=1)
	o.LoosePlatform(pos=(11.5,-35.8,U),t=1)
	o.LoosePlatform(pos=(13,-36.1,U),t=1)
	o.spw_block(ID=5,p=(14,-36.2,U),vx=[8,1])
	o.spw_block(ID=5,p=(21,-36.2,U),vx=[1,1])
	o.spw_block(ID=5,p=(21.75,-35.7,U),vx=[1,1])
	o.spw_block(ID=5,p=(24,-35.7,U),vx=[1,1])
	o.spw_block(ID=5,p=(24.75,-36.2,U),vx=[3,1])
	o.spw_block(ID=5,p=(31.17,-36.2,U),vx=[6,1])
	#crate
...
def gem_zone():
	...
	o.spw_block(ID=5,p=(200,bnh,U),vx=[1,1])
	o.spw_block(ID=5,p=(200,bnh,U+1.5),vx=[2,1])
	for rn_a in range(3):
		o.spw_block(ID=5,p=(200+(.75*3+rn_a*1.5),bnh,U+1.5),vx=[1,1])
	del rn_a
	o.spw_block(ID=5,p=(206.5,bnh,U+1.5),vx=[2,1])
	for rn_b in range(5):
		o.spw_block(ID=5,p=(200.5+.75*8,bnh,U+(.75*3+rn_b*1.5)),vx=[1,1])
	del rn_b
	o.spw_block(ID=5,p=(206.4-.75,bnh,6.8),vx=[2,1])
	for rn_c in range(7):
		o.spw_block(ID=5,p=(202+(.75*3-rn_c*1.5),bnh,U+.75*13),vx=[1,1])
	del rn_c
	o.spw_block(ID=5,p=(194,bnh,U+.75*13),vx=[1,3])
	for rn_dx in range(1):
		for rn_dz in range(4):
			o.spw_block(ID=5,p=(189.5+.75*6+(rn_dx*1.5),bnh,U+(.75*17)+(rn_dz*1.3)),vx=[1,1])
	del rn_dx,rn_dz
	o.spw_block(ID=5,p=(194,bnh,15.5),vx=[1,5])
	for llpf in range(8):
		o.LoosePlatform(pos=(194,-2.6,19.5+llpf*1.5),t=0)
	del llpf
	o.spw_block(ID=5,p=(193.25,bnh,31.6),vx=[4,2])
