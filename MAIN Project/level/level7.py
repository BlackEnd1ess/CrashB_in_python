...
def load_object():
	...
	o.ObjType_Deco(ID=11,pos=(21,1.1,-36),sca=.05,rot=(-90,90,0))
	...
	o.ObjType_Block(ID=5,pos=(95,4.5,1),sca=(.5,.8,.5),typ=1,ro_y=90)
	dg.Piston(pos=(95,4.65+4.2,1),typ=0,spd=4)
	o.ObjType_Block(ID=5,pos=(96,4.5,1),sca=(.5,.8,.5),typ=1,ro_y=90)
	...
	o.spw_block(ID=5,p=(38,3,-30),vx=[12,1],ro_y=0)
