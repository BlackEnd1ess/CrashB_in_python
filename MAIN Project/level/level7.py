...
def load_object():
	...
	#pistons
	o.ObjType_Block(ID=6,pos=(20.5,2,-36),sca=(.5,.8,.5),typ=1,ro_y=90)
	dg.Piston(pos=(20.5,2.05+4.2,-36),typ=0,spd=2)
	o.ObjType_Block(ID=6,pos=(29,3,-36),sca=(.5,.8,.5),typ=1,ro_y=90)
	dg.Piston(pos=(29,3.05+4.2,-36),typ=0,spd=2)
	o.ObjType_Block(ID=6,pos=(33,3,-36),sca=(.5,.8,.5),typ=1,ro_y=90)
	dg.Piston(pos=(33,3.05+4.2,-36),typ=0,spd=2)
	o.ObjType_Block(ID=6,pos=(59,3.6,-13),sca=(.5,.8,.5),typ=1,ro_y=90)
	dg.Piston(pos=(59,3.65+4.2,-13),typ=0,spd=3)
	o.ObjType_Block(ID=6,pos=(60,3.6,-13),sca=(.5,.8,.5),typ=1,ro_y=90)
	...
	#e1
	o.spw_block(ID=5,p=(0,0,-62),sca=(5.,.8,.5),vx=[1,4],ro_y=90)
	o.spw_block(ID=5,p=(0,0,-57),sca=(5.,.8,.5),vx=[3,1],ro_y=0)
	o.spw_block(ID=5,p=(4,0,-57),sca=(5.,.8,.5),vx=[1,1],ro_y=0)
