...
def load_object():
	...
	o.Piston(pos=(59,3.7+4.2,-13),typ=0,spd=3)
	o.Piston(pos=(60,3.7+4.2,-13),typ=0,spd=3)
	#e pads
	...
	o.spw_lab_tile(p=(59,3.6,-13),cnt=3,way=0,typ=0)
	o.spw_lab_tile(p=(62,3.6,-13),cnt=5,way=1,typ=0)
	o.spw_lab_tile(p=(63,3.6,-9),cnt=1,way=0,typ=0)
	o.spw_lab_tile(p=(65,3.6,-9),cnt=1,way=0,typ=0)
	...
	o.spw_lab_tile(p=(79,3.3,1),cnt=8,way=0,typ=0)
	o.spw_lab_tile(p=(87,5.105,1),cnt=7,way=0,typ=0)
