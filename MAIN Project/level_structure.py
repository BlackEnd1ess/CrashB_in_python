...
def lv1_object():
	...
	o.bush(pos=(-1,1.4,-12),sca=2,c=cG)
	o.bush(pos=(1,1.4,-12),sca=2,c=color.orange)
	o.bush(pos=(2.43,1.5,10.7),sca=2,c=cG)
	o.bush(pos=(-2,1.5,10.2),sca=2,c=color.yellow)
	o.TreeScene(pos=(-1.5,1.6,19.3),sca=.02)
	o.TreeScene(pos=(1.2,1.8,19.3),sca=.02)
	o.TreeScene(pos=(1.1,1.5,11),sca=.02)
	o.TreeScene(pos=(.5,1.3,2.5),sca=.02)
	o.TreeScene(pos=(0,1,-2),sca=.013)
	o.TreeScene(pos=(0,1,6),sca=.013)
	o.bush(pos=(2.43,1.4,23),sca=3,c=cG)
	o.bush(pos=(-2.37,1.4,23),sca=3,c=color.yellow)
	...
	#platform grass
	bu_h=.85
	o.bush(pos=(-1,bu_h,-45.3),sca=(1.2,.5,.1),c=cG)
	o.bush(pos=(.7,bu_h,-45.3),sca=(1.2,.5,.1),c=cG)
	o.bush(pos=(-1.5,bu_h,-38.61),sca=(1.4,.5,.1),c=cG)
	o.bush(pos=(-.6,bu_h,-38.611),sca=(1.4,.5,.1),c=cG)
	o.bush(pos=(.5,bu_h,-38.609),sca=(1.4,.5,.1),c=cG)
	o.bush(pos=(1.5,bu_h,-38.608),sca=(1.4,.5,.1),c=cG)
	o.bush(pos=(-2,.9,-28.55),sca=(1.4,.5,.1),c=cG)
	o.bush(pos=(.6,bu_h,-23.1),sca=(1.4,.5,.1),c=cG)
	o.bush(pos=(-1.4,bu_h,-16.1),sca=(1.4,.5,.1),c=cG)
	o.bush(pos=(-.6,bu_h,-16.11),sca=(1.4,.5,.1),c=cG)
	o.bush(pos=(.2,bu_h,-16.12),sca=(1.4,.5,.1),c=cG)
	o.bush(pos=(1.2,bu_h,-16.09),sca=(1.6,.5,.1),c=cG)
	o.bush(pos=(0,1,-26.37),sca=(3,2,.1),c=cG)
	o.bush(pos=(-1,1,-4.12),sca=(1.5,1.5,.1),c=cG)
	o.bush(pos=(-2,1,-4.13),sca=(1.5,1.5,.1),c=cG)
	o.bush(pos=(1.3,1,-4.13),sca=(1.7,1.5,.1),c=cG)
	o.bush(pos=(1.1,1,-57),sca=(2,1.5,.1),c=cG)
	o.bush(pos=(-.7,1,-55),sca=(2,1.5,.1),c=color.orange)
	o.bush(pos=(-.8,3,22.75),sca=(2,1.5,.1),c=color.rgb32(0,80,0))
	o.bush(pos=(.4,3,23),sca=(2,1.5,.1),c=color.rgb32(0,80,0))
	o.bush(pos=(-.2,3.3,22.8),sca=(2,1.5,.1),c=color.rgb32(0,80,0))
	#platform
	d0=.85
...
def lv2_wumpa():
	...
	mt.wumpa_double_row(POS=(-.5,1.5,2.5),CNT=8)
	mt.wumpa_double_row(POS=(5.7,1.8,2.5),CNT=3)
	mt.wumpa_double_row(POS=(13,2.85,2.5),CNT=12)
	mt.wumpa_double_row(POS=(22.4,2.85,2.5),CNT=5)
...
def lv3_crate():
	...
	mt.crate_plane(ID=2,POS=(-.85,-.05+.16,-15),CNT=[3,3])
...
def lv4_object():
	...
	Entity(model='cube',scale=(16,1,64),position=(14.5,2.9,83),collider='box',color=color.black)
	#walls
