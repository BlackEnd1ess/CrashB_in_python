...
def gem_route1():
	...
	for moss_x in range(3):
		for moss_z in range(5):
			o.MossPlatform(p=(201+moss_x,2.6,42+moss_z*1.2),ptm=random.randint(0,1))
	...
	o.spawn_tree_wall(pos=(205,3.8,32),cnt=11,d=1)
	#bush
	...
	#crate
	MT.crate_wall(ID=1,POS=(199.3,.29,-4.6),CNT=[1,2])
	MT.crate_plane(ID=1,POS=(200.3,3.29-.32,32.3),CNT=[3,3])
	MT.crate_plane(ID=11,POS=(201.1,3.29-.32,35.3),CNT=[3,3])
	MT.crate_plane(ID=1,POS=(200.3,3.29-.32,38.3),CNT=[3,3])
