...
def bonus1():
	...
	o.Water(pos=(0,-39,0),s=(60,60),c=color.rgb32(100,110,110),a=.9,typ=2)
	for w in range(2):
...
def bonus2():
	...
	MT.wumpa_double_row(POS=(-.5,-37.2,U),CNT=5)
	MT.wumpa_double_row(POS=(10,-36.4,U),CNT=7)
	MT.wumpa_double_row(POS=(10,-37,U),CNT=7)
	MT.wumpa_double_row(POS=(2.8,-37.2,U),CNT=8)
	MT.wumpa_double_row(POS=(7,-37.2,U),CNT=8)
	o.BonusPlatform(pos=(16,-37.2,U))

def bonus3():
	Entity(model='plane',texture='res/ui/background/bonus_1.jpg',scale=(60,1,30),position=(10,-40,15),rotation_x=-90,unlit=False)
	MT.wumpa_double_row(POS=(12.8,-35.3,U),CNT=6)
	MT.wumpa_double_row(POS=(-.5,-36.8,U),CNT=4)
	MT.wumpa_row(POS=(1.5,-36.65,U),CNT=3,WAY=0)
	MT.wumpa_row(POS=(3.5,-35.65,U),CNT=3,WAY=0)
	MT.wumpa_row(POS=(5.5,-35.15,U),CNT=3,WAY=0)
	MT.wumpa_row(POS=(17.5,-35.65,U),CNT=3,WAY=0)
	o.FallingZone(pos=(0,-40,0),s=(64,1,64))
	...
	c.place_crate(ID=11,p=(12.5,-36,U-.1))
	MT.crate_row(ID=12,POS=(12.82,-36,U-.1),WAY=0,CNT=7)
	MT.crate_row(ID=1,POS=(12.82,-35.68,U-.1),WAY=0,CNT=7)
	o.MushroomTree(pos=(16,-38,U+1),typ=1)
	o.MushroomTree(pos=(18,-38,U+1),typ=1)
	MT.crate_wall(ID=1,POS=(15.8,-35.65+.16,U-.1),CNT=[2,3])
	c.place_crate(ID=2,p=(4,-36.65+.16,U-.1))
	c.place_crate(ID=4,p=(5.8,-35.1,U-.1))
