...
def level1():##wood
	...
	#scene
	gs=1.6
	o.GrassSide(pos=(-4.5,gs,-47),ry=0)
	o.GrassSide(pos=(-4.5,gs,-16),ry=0)
	o.GrassSide(pos=(-4.5,gs,15),ry=0)
	o.GrassSide(pos=(-4.5,gs,46),ry=0)
	...
	o.spawn_tree_wall(pos=(-5.7,1.8,-63),cnt=50,d=0)
	o.spawn_tree_wall(pos=(4.5,1.8,-64),cnt=50,d=1)
