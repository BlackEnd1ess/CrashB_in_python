...
def level5():## ruins
	...
	mt.crate_plane(ID=1,POS=(.7,0,-35.7),CNT=[5,2])
	mt.crate_plane(ID=2,POS=(12.1,.36,-27.8),CNT=[3,3])
	mt.crate_plane(ID=2,POS=(11.4,.36,-9.6),CNT=[3,3])
	mt.crate_plane(ID=2,POS=(35.6,1.26,9.5),CNT=[3,3])
	mt.crate_plane(ID=1,POS=(52.1,1.26,15.7),CNT=[3,3])
	mt.crate_block(ID=2,POS=(29.8,.36,-1),CNT=[3,2,2])
	mt.crate_block(ID=1,POS=(37.1,1.26,9.6),CNT=[2,2,2])
	mt.crate_block(ID=2,POS=(53.6,1.26,16.1),CNT=[2,2,2])
	mt.crate_block(ID=1,POS=(43.5,-.34,4.7),CNT=[1,2,2])
	mt.crate_block(ID=2,POS=(46.4,-.34,4.7),CNT=[1,2,2])
	...
	#wumpa front
	mt.wumpa_row(POS=(0,.5,-60.3),CNT=8,WAY=1)
	mt.wumpa_row(POS=(2.7,.5,-55.3),CNT=8,WAY=1)
	mt.wumpa_row(POS=(2.7,.5,-44.0),CNT=6,WAY=1)
	mt.wumpa_row(POS=(12,.5,-32.3),CNT=6,WAY=1)
	mt.wumpa_row(POS=(25,.5,-0.4),CNT=12,WAY=1)
	mt.wumpa_row(POS=(34.5,1.4,5.3),CNT=12,WAY=1)
	mt.wumpa_row(POS=(39,1.4,4.7),CNT=8,WAY=1)
	mt.wumpa_row(POS=(53.2,1.4,5.4),CNT=8,WAY=1)
	mt.wumpa_row(POS=(52.4,1.4,16.6),CNT=8,WAY=1)
	mt.wumpa_row(POS=(55.4,1.4,21.7),CNT=8,WAY=1)
	#wumpa right
	mt.wumpa_row(POS=(1.2,.5,-56),CNT=6,WAY=0)
