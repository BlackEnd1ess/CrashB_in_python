...
def load_object():
	...
	o.ObjType_Movable(ID=0,pos=(0,.52,-42),ptm=2,drc='z',rng=2.4,pts=1,ptw=2)
	o.ObjType_Movable(ID=0,pos=(-2,.5,-6),ptm=0)
	o.ObjType_Movable(ID=0,pos=(0,.52,14),ptm=2,drc='z',rng=2,pts=1,ptw=2)
...
def load_npc():
	...
	n.Bird(pos=(-.2,1,-57.1))
	n.Bird(pos=(-.6,1.34,-48.7))
	n.Bird(pos=(-.12,1,-32))
	n.Bird(pos=(.1,1,-30))
	n.Bird(pos=(-2,1,-23.7))
	n.Bird(pos=(.6,1,-15.8))
	n.Bird(pos=(.1,1,-8.1))
	n.Bird(pos=(2.2,1,-2.1))
	n.Bird(pos=(1.1,1,8.9))
	n.Bird(pos=(-.3,1,18.8))
	n.Bird(pos=(.2,1,18.8))
	n.Bird(pos=(0,1,19.2))
	n.Bird(pos=(0,1,19.7))
