...
def load_crate():
	...
	c.spawn(ID=14,p=(-.8,1.21,2))
	c.spawn(ID=1,p=(0,u0,24.5))
	c.spawn(ID=2,p=(0,u0,27.5))
	c.spawn(ID=3,p=(0,u0+.32,27.5))
	c.spawn(ID=1,p=(0,u0,30.5))
	c.spawn(ID=2,p=(0,u0,34.5))
	c.spawn(ID=3,p=(0,u0,35.5))
	c.spawn(ID=1,p=(-1,u0,35.5))
	c.spawn(ID=2,p=(-1,u0,36.5))
	c.spawn(ID=1,p=(-1,u0,37.5))
	c.spawn(ID=3,p=(0,u0,37.5))
	c.spawn(ID=1,p=(0,u0,38.5))
	c.spawn(ID=4,p=(0,u0,39.5))
	c.spawn(ID=2,p=(-1.4,.24+.16,-11.5))
	mt.crate_plane(ID=1,POS=(-.4,u0,44),CNT=[2,3])
	mt.crate_plane(ID=1,POS=(.3,u0,48),CNT=[2,2])
	c.spawn(ID=9,p=(1.3,1.16,52.4),m=1)
	for _c in range(10):
		c.spawn(ID=13,p=(0,u0,52.4+.32*_c),m=1,l=0)
	mt.crate_plane(ID=1,POS=(0,1.8,70),CNT=[1,3])
	c.spawn(ID=10,p=(.85,1.97+.16,80.85))
	mt.crate_wall(ID=1,POS=(-.175,1.05+.16,14.5),CNT=[2,1])
	mt.crate_row(ID=1,POS=(-.85,1.05+.16,40.4),CNT=2,WAY=1)
	c.spawn(ID=7,p=(-1,2.04+.16,58.4))
	mt.crate_row(ID=1,POS=(-1,4.5,58.4),CNT=4,WAY=2)
	mt.bounce_twin(POS=(1,2.04+.16,58.4),CNT=1)
	#aku
	c.spawn(ID=5,p=(-.85,1.05+.16,9.3))
	#checkpoints
	c.spawn(ID=6,p=(0,.24+.16,-9.2))
	c.spawn(ID=6,p=(0,1.05+.16,32.8))
	c.spawn(ID=6,p=(.85,1.05+.16,44.6))
	c.spawn(ID=6,p=(0,2.04+.16,58.5))
def load_wumpa():
