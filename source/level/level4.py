...
def load_crate():
	...
	#nitro
	c.spawn(ID=12,p=(5.27,1.9,17))
	c.spawn(ID=7,p=(5.27,1.9+.32,17))
	c.spawn(ID=3,p=(5.27,4,17))
	c.spawn(ID=12,p=(.78,.16,-52.2))
	c.spawn(ID=14,p=(.7,.56,-45.1))
	c.spawn(ID=12,p=(.52,.16,-37.2))
	c.spawn(ID=12,p=(-.50,.16,-35.5))
	c.spawn(ID=12,p=(.1,.16,-33.3))
	c.spawn(ID=12,p=(.15,.56,-29.1-.32))
	c.spawn(ID=12,p=(-.65,.56,-22.7))
	c.spawn(ID=14,p=(.14,.16,-17.1))
	c.spawn(ID=12,p=(.99,.16,-15.3))
	c.spawn(ID=12,p=(-.21,.16,-9.75))
	c.spawn(ID=12,p=(-.72,.16,-6.8))
	c.spawn(ID=12,p=(-.38,.16,-4.2))
	c.spawn(ID=12,p=(-.96,.91,-.1))
	c.spawn(ID=12,p=(.08,.91,-.1))
	c.spawn(ID=12,p=(1.08,.91,-.1))
	c.spawn(ID=12,p=(4.49,1.6,8))
	c.spawn(ID=12,p=(3.53,1.3,8))
	c.spawn(ID=12,p=(4.96,1.9,15))
	c.spawn(ID=12,p=(5.04,1.9,21.9))
	c.spawn(ID=12,p=(13.62,3.56,56.1))
	c.spawn(ID=12,p=(15.27,3.56,56.1))
	c.spawn(ID=12,p=(14.59,3.56,61))
	c.spawn(ID=12,p=(13.77,3.56,63.1))
	c.spawn(ID=12,p=(15.22,3.56,64.9))
	c.spawn(ID=10,p=(13.74,3.9,72.7))
	...
	#checkpoints
	c.spawn(ID=6,p=(0,.56,-43))
	c.spawn(ID=6,p=(0,.91,3.6))
	c.spawn(ID=6,p=(5,1.9,30.4))
	c.spawn(ID=6,p=(14.5,3.9,49.9))
	#aku
...
def bonus_zone():
	...
	#crate
	c.spawn(ID=4,p=(2,-35.9+.16,U))
	c.spawn(ID=1,p=(2,-35.9+.48,U))
	c.spawn(ID=7,p=(4.4,-35.4+.16,U))
	c.spawn(ID=11,p=(4.4-.32,-35.4+.16,U))
	c.spawn(ID=12,p=(5.57,-33.74,U))
	c.spawn(ID=12,p=(6.49,-33.74,U))
	c.spawn(ID=12,p=(7.45,-33.74,U))
	c.spawn(ID=9,p=(10,-33.7,U),m=2)
	...
	c.spawn(ID=11,p=(21.2,-34.24,U))
	c.spawn(ID=12,p=(12.97,-35.74,U))
	c.spawn(ID=1,p=(12.97,-35.74+.32,U))
	c.spawn(ID=12,p=(14.12,-35.24,U))
	c.spawn(ID=2,p=(14.12,-35.24+.32,U))
	c.spawn(ID=12,p=(14.97,-34.74,U))
	c.spawn(ID=1,p=(14.97,-34.74+.32,U))
	c.spawn(ID=12,p=(15.98,-34.24,U))
	c.spawn(ID=1,p=(15.98,-34.24+.32,U))
	c.spawn(ID=12,p=(16.97,-34.24,U))
	c.spawn(ID=1,p=(16.97,-34.24+.32,U))
	#wumpa fruits
...
def gem_zone():
	...
	#gem route crate
	c.spawn(ID=0,p=(200,-.5,-2))
	c.spawn(ID=0,p=(200,-.5,2))
	c.spawn(ID=9,p=(200,-.5,3),m=101)
	c.spawn(ID=13,p=(200,-.5,4),l=8,m=101)
	c.spawn(ID=9,p=(200,-.5,6),m=102)
