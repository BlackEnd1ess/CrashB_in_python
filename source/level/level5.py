...
def load_object():
	...
	o.spw_block(ID=4,ro_y=-90,p=(0,blh,-61),vx=[1,3])
	o.spw_block(ID=4,ro_y=-90,p=(0,blh,-61+.75*5),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(1.2,blh,-56),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(1.2+.75*2,blh,-56),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(1.2+.75*4,blh,-56),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(1.2+.75*2,blh,-55.25),vx=[1,2])
	o.spw_block(ID=4,ro_y=-90,p=(1.2+.75*2,blh,-55.25+.75*4),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(1.2+.75*2,blh,-50.5),vx=[1,1])
	o.ObjType_Corridor(ID=1,pos=(2.7,blh-.5,-47),rot=(0,0,0))
	o.spw_block(ID=4,ro_y=-90,p=(1.2+.75*2,blh,-44),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(1.2+.75*2,blh,-44+.75*2),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(1.2+.75*2,blh,-44+.75*4),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(1.2+.75*2,blh,-44+.75*6),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(1.2+.75*1,blh,-44+.75*7),vx=[3,1])
	o.spw_block(ID=4,ro_y=-90,p=(1.2+.75*2,blh,-44+.75*9),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(1.2+.75*2,blh,-44+.75*11),vx=[1,1])
	...
	o.spw_block(ID=4,ro_y=-90,p=(9,blh,-33),vx=[2,1])
	o.spw_block(ID=4,ro_y=-90,p=(9+.75*4,blh,-33),vx=[1,3])
	o.ObjType_Corridor(ID=1,pos=(12,blh-.5,-28.5),rot=(0,0,0))
	o.spw_block(ID=4,ro_y=-90,p=(9+.75*4,blh,-25),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(9+.75*4,blh,-23.5),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(9+.75*4,blh,-22),vx=[3,1])
	o.spw_block(ID=4,ro_y=-90,p=(9+.75*4,blh,-20.5),vx=[1,1])
	...
	o.spw_block(ID=4,ro_y=-90,p=(9+.75*4,blh,-8.1),vx=[1,1])
	o.ObjType_Floor(ID=5,pos=(12,blh,-6.9),sca=(.03,.03,.03),rot=(0,-90,0))
	o.spw_block(ID=4,ro_y=-90,p=(13.2,blh,-7),vx=[1,4])
	o.spw_block(ID=4,ro_y=-90,p=(13.2,blh,-7+.75*5.5),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(13.2,blh,-7+.75*8),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(14.7,blh,-7+.75*8),vx=[2,1])
	o.spw_block(ID=4,ro_y=-90,p=(14.7+.75*3,blh,-7+.75*8),vx=[2,1])
	o.LoosePlatform(pos=(19,.2,-1),t=0)
	o.LoosePlatform(pos=(20.5,.2,-1),t=0)
	o.spw_block(ID=4,ro_y=-90,p=(22,blh,-7+.75*8),vx=[4,1])
	o.spw_block(ID=4,ro_y=-90,p=(22+.75*4,blh,-7+.75*8),vx=[1,2])
	o.spw_block(ID=4,ro_y=-90,p=(22+.75*4,blh,-7+.75*11),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(22+.75*4,blh,-7+.75*13),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(22+.75*6,blh,-7+.75*8),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(22+.75*8,blh,-7+.75*8),vx=[1,1])
	...
	blk=1.1
	o.spw_block(ID=4,ro_y=-90,p=(30,blk,4.7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*2,blk,4.7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*4,blk,4.7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*6,blk,4.7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*6,blk,4.7+.75*2),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*6,blk,4.7+.75*4),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*6,blk,4.7+.75*5),vx=[2,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*10,blk,4.7+.75*5),vx=[3,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*12,blk,4.7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*12,blk,4.7+.75*2),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*12,blk,4.7+.75*4),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*14,-.2+.5,4.7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*16,-1+.5,4.7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*18,-1+.5,4.7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*20,-1+.5,4.7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*22,-1+.5,4.7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*24,-.6+.5,4.7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*25,-.2+.5,4.7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*25,.2+.5,4.7+.75),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*26,blk,4.7+.75),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*28,blk,4.7+.75),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*30,blk,4.7+.75),vx=[1,1])
	...
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*31,blk,4.7+.75),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*31,blk,4.7+.75*3),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(30+.75*31,blk,4.7+.75*5),vx=[1,1])
	...
	o.spw_block(ID=4,ro_y=-90,p=(52.45,blk,15.75),vx=[3,2])
	o.spw_block(ID=4,ro_y=-90,p=(53.2-.75,blk,15+.75*3),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(53.2-.75,blk,15+.75*5),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(53.2-.75,blk,15+.75*7),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(53.2-.75,blk,15+.75*8),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(53.2-.75+.75*2,blk,15+.75*8),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(53.2-.75+.75*4,blk,15+.75*8),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(53.2+.75*3,blk,15+.75*8),vx=[1,1])
...
def load_crate():
	...
	c.spawn(ID=12,p=(-.2,.36,-55.6))
	c.spawn(ID=12,p=(3.5,.36,-55.9))
	c.spawn(ID=12,p=(3.3,.36,-47.5))
	c.spawn(ID=12,p=(1.9,.36,-47.5))
	c.spawn(ID=12,p=(1.9,.36,-46))
	c.spawn(ID=12,p=(5.6,.36,-33.1))
	c.spawn(ID=12,p=(2.5,.36,-37.2))
	c.spawn(ID=12,p=(7.5,.36,-33))
	c.spawn(ID=12,p=(11.3,.36,-11.5))
	c.spawn(ID=12,p=(11.1,.36,-13.7))
	c.spawn(ID=12,p=(12.6,.36,-13.7))
	c.spawn(ID=12,p=(15.4,.36,-1))
	c.spawn(ID=10,p=(56.2,1.26,24.7))
...
def bonus_zone():
	...
	o.spw_block(ID=4,ro_y=-90,p=(-1,-36.5,U),vx=[4,1])
	o.spw_block(ID=4,ro_y=-90,p=(2,-36,U),vx=[2,1])
	...
	o.spw_block(ID=4,ro_y=-90,p=(21.75,-35.7,U),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(24,-35.7,U),vx=[1,1])
	o.spw_block(ID=4,ro_y=-90,p=(24.75,-36.2,U),vx=[3,1])
	o.spw_block(ID=4,ro_y=-90,p=(31.17,-36.2,U),vx=[6,1])
	#crate
...
def gem_zone():
	...
	del rn_c
	o.spw_block(ID=4,ro_y=-90,p=(194,bnh,U+.75*13),vx=[1,3])
	for rn_dx in range(1):
		for rn_dz in range(4):
			o.spw_block(ID=4,ro_y=-90,p=(189.5+.75*6+(rn_dx*1.5),bnh,U+(.75*17)+(rn_dz*1.3)),vx=[1,1])
	del rn_dx,rn_dz
	o.spw_block(ID=4,ro_y=-90,p=(194,bnh,15.5),vx=[1,5])
	for llpf in range(8):
