...
def load_crate():
	#iron
	c.spawn(ID=0,p=(6,.6+.16,-51.3))
	#checkp
	c.spawn(ID=6,p=(14.2,2.27,-46.1))
	c.spawn(ID=6,p=(25.0,3.27,-36.0))
	c.spawn(ID=6,p=(51.0,3.87,-14.1))
	c.spawn(ID=6,p=(63.0,3.87,-9.1))
	c.spawn(ID=6,p=(82.1,3.57,1.0))
	#akuaku
	c.spawn(ID=5,p=(6.1,.72,-57.1))
	c.spawn(ID=5,p=(35,3.27,-36.1))
	c.spawn(ID=5,p=(54.2,3.87,-13.0))
	c.spawn(ID=5,p=(89.1,4.83,.9))
	c.spawn(ID=10,p=(101,4.83,4.9))
	#default
	c.spawn(ID=1,p=(89.1,4.83+.32,.9))
	c.spawn(ID=4,p=(8.9,.8,-46))
	c.spawn(ID=13,p=(18.3,2.1+.16,-36),m=71,l=2)
	c.spawn(ID=9,p=(37,2.52+.16,-37),m=71)
	c.spawn(ID=7,p=(8,.6+.16,-57))
	c.spawn(ID=11,p=(8-.32,.6+.16,-57))
	...
	#bridge crates
	c.spawn(ID=1,p=(37,3.1-.16,-33.3))
	c.spawn(ID=12,p=(37,3.1-.16,-33.3+.32))
	c.spawn(ID=3,p=(37,3.1-.16,-33.3+.64))
	c.spawn(ID=12,p=(37,3.1-.16,-33.3+.96))
	c.spawn(ID=2,p=(37,3.1-.16,-33.3+1.28))
	c.spawn(ID=12,p=(37,3.1-.16,-33.3+1.6))
def load_wumpa():
...
def bonus_zone():
	...
	c.spawn(ID=7,p=(.7,-36.93,U))
	mt.crate_wall(ID=1,POS=(.7,-34.8,U),CNT=[1,3])
	c.spawn(ID=1,p=(11.6,-36.93,U))
	c.spawn(ID=2,p=(14.4,-36.93,U))
	c.spawn(ID=3,p=(27.4,-35.93,U))
	c.spawn(ID=13,p=(29.6,-34.19,U),m=129,l=2)
	c.spawn(ID=13,p=(31.9,-34.19,U),m=129,l=4)
	c.spawn(ID=9,p=(34.5,-35.93,U),m=129)
	c.spawn(ID=2,p=(34.5,-34.7,U))
