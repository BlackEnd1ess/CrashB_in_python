...
def load_crate():
	c.spawn(ID=10,p=(61.6,.5+.16,146.1))
	c.spawn(ID=8,p=(23.1,1.16,57.1))
	c.spawn(ID=8,p=(20.4,2.5+.16,58.1))
	c.spawn(ID=4,p=(60.5,2,116))
	c.spawn(ID=2,p=(60.5,1.6,118))
	c.spawn(ID=1,p=(60.5,1.2,120))
	c.spawn(ID=1,p=(60.5,.8,122))
	#nitro
	...
	c.spawn(ID=12,p=(12.8,1.16,22.2))
	c.spawn(ID=12,p=(13.7,1.16,21.7))
	c.spawn(ID=12,p=(16.6,1.16,22.2))
	c.spawn(ID=12,p=(36.7,2.66,66.8))
	c.spawn(ID=12,p=(38.8,2.66,67.4))
	c.spawn(ID=12,p=(40.7,2.66,66.8))
	c.spawn(ID=12,p=(44.0,2.66,66.8))
	c.spawn(ID=12,p=(51.1,2.66,66.8))
	c.spawn(ID=12,p=(51.7,2.66,69.1))
	c.spawn(ID=12,p=(52.2,2.66,72.7))
	c.spawn(ID=12,p=(51.7,2.66,75.7))
	c.spawn(ID=12,p=(42.2,2.66,67.3))
	c.spawn(ID=12,p=(53.3,2.66,93.7))
	c.spawn(ID=12,p=(51.1,2.66,93.7))
	mt.crate_row(ID=13,POS=(60.5,2.16,112.3),m=127,l=6,CNT=1,WAY=0)
	c.spawn(ID=12,p=(60.3,.5+.16,142.3))
	c.spawn(ID=12,p=(60.7,.5+.16,142.3))
	c.spawn(ID=12,p=(58.8,.66,125.2))
	c.spawn(ID=12,p=(62,.66,126.2))
	c.spawn(ID=12,p=(60.6,.66,126.5))
	c.spawn(ID=12,p=(62.5,.66,128.8))
	c.spawn(ID=12,p=(61.0,.66,128.8))
	c.spawn(ID=12,p=(59.9,.66,128.8))
	c.spawn(ID=12,p=(58.3,.66,128.8))
	c.spawn(ID=12,p=(59.3,.66,130.3))
	c.spawn(ID=12,p=(62,.66,131.2))
	c.spawn(ID=12,p=(59.4,.66,132.3))
	c.spawn(ID=12,p=(61.2,.66,132.3))
	c.spawn(ID=12,p=(59.5,.66,138.2))
	#checkp
	c.spawn(ID=6,p=(22,1.16,34.7))
	c.spawn(ID=6,p=(34,4.16,61.7))
	c.spawn(ID=6,p=(52.5,2.66,79.5))
	c.spawn(ID=6,p=(53,1.66,103.7))
	#aku
	c.spawn(ID=5,p=(7.9,.66,11.3))
	c.spawn(ID=5,p=(21.3,.66,40.1))
	c.spawn(ID=5,p=(51.2,2.66,81.5))
	#
	c.spawn(ID=7,p=(7.9+.32,.66,11.3))
	c.spawn(ID=2,p=(7.9+.32,2.5,11.3))
	c.spawn(ID=2,p=(7.9+.32,2.5+.32,11.3))
	c.spawn(ID=7,p=(22,2.16,27.8))
	c.spawn(ID=3,p=(22,4,27.8))
	mt.crate_row(ID=0,POS=(53.4,2.659,79.4),WAY=2,CNT=1)
	c.spawn(ID=2,p=(53.4,2.66+.32,79.4))
	mt.crate_row(ID=0,POS=(53.4,2.66,80.3),WAY=2,CNT=2)
	c.spawn(ID=4,p=(53.4,2.66+.64,80.3))
	mt.crate_row(ID=0,POS=(53.4,2.66,81),WAY=2,CNT=3)
	c.spawn(ID=1,p=(53.4,2.66+.96,81))
	mt.crate_row(ID=14,POS=(53.4,2.66,82.1),WAY=2,CNT=4)
	c.spawn(ID=14,p=(53.4,2.66+1.28,82.1))
	...
	c.spawn(ID=3,p=(58,1.6,111.5))
	c.spawn(ID=1,p=(61.3,0.66,125.7))
	c.spawn(ID=2,p=(59.5,0.66,126.2))
	c.spawn(ID=1,p=(60.7,0.66,130.5))
	c.spawn(ID=2,p=(62.5,0.66,130.2))
	c.spawn(ID=1,p=(58.4,0.66,131.1))
...
def bonus_zone():
	...
	c.spawn(ID=9,p=(-1,-36.84,U-j),m=181)
	...
	c.spawn(ID=8,p=(6.2,-37.4,U-j))
	mt.crate_row(ID=4,POS=(6.2,-35,U-j),CNT=2,WAY=2)
	c.spawn(ID=3,p=(7.2,-36+.16,U-j))
	c.spawn(ID=11,p=(7.2,-34,U-j))
	c.spawn(ID=2,p=(7.2,-34+.32,U-j))
	c.spawn(ID=14,p=(11,-36+.16,U-j))
	...
	c.spawn(ID=12,p=(13.3,-36+.16,U-j))
	c.spawn(ID=12,p=(14.3,-36+.16,U-j))
	c.spawn(ID=1,p=(14.3,-34.5,U-j))
	c.spawn(ID=12,p=(14.3,-34.5+.32,U-j))
	c.spawn(ID=12,p=(15.3,-36+.16,U-j))
	#
...
def gem_zone():
	...
	#crates
	c.spawn(ID=6,p=(200,-1.84,-9.8))
	c.spawn(ID=6,p=(200,-2.84,-51.5))
	...
	c.spawn(ID=9,p=(199.7,-4.84,-95),m=127)
	#wumpa fruits
